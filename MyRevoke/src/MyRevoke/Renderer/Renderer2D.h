...
namespace Revoke
{
	...
	public:
		...
		static void DrawTriangle(const glm::vec3& position, const glm::vec2 size, const Shared<Texture2D>& texture);
		static void DrawTriangle(const glm::vec2& position, const glm::vec2 size, const Shared<Texture2D>& texture);
