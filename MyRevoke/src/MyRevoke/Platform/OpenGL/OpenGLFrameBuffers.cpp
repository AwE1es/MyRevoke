...
namespace Revoke
{
    ...
    uint32_t OpenGLFrameBuffers::GetColorAttachmentRendererID(uint32_t index) const
    {
    ...
    int OpenGLFrameBuffers::ReadPixel(uint32_t attachmentIndex, int x, int y)
    {
    ...
    void OpenGLFrameBuffers::ClearColorTextureAttachment(uint32_t attachmentIndex, int value)
    {
